...
mMaps.insert(std::make_pair("glsl_sdpa_flash_mnn_D_HEAD_64_SMALL_comp", std::make_pair(glsl_sdpa_flash_mnn_D_HEAD_64_SMALL_comp,glsl_sdpa_flash_mnn_D_HEAD_64_SMALL_comp_len)));
mMaps.insert(std::make_pair("glsl_sdpa_flash_mnn_D_HEAD_128_SMALL_comp", std::make_pair(glsl_sdpa_flash_mnn_D_HEAD_128_SMALL_comp,glsl_sdpa_flash_mnn_D_HEAD_128_SMALL_comp_len)));
...
mMaps.insert(std::make_pair("glsl_sdpa_flash_coopmat_mnn_comp", std::make_pair(glsl_sdpa_flash_coopmat_mnn_comp,glsl_sdpa_flash_coopmat_mnn_comp_len)));
mMaps.insert(std::make_pair("glsl_sdpa_flash_coopmat_mnn_D_HEAD_64_comp", std::make_pair(glsl_sdpa_flash_coopmat_mnn_D_HEAD_64_comp,glsl_sdpa_flash_coopmat_mnn_D_HEAD_64_comp_len)));
mMaps.insert(std::make_pair("glsl_sdpa_flash_coopmat_mnn_D_HEAD_128_comp", std::make_pair(glsl_sdpa_flash_coopmat_mnn_D_HEAD_128_comp,glsl_sdpa_flash_coopmat_mnn_D_HEAD_128_comp_len)));
mMaps.insert(std::make_pair("glsl_sdpa_flash_coopmat_mnn_D_HEAD_64_OPT_comp", std::make_pair(glsl_sdpa_flash_coopmat_mnn_D_HEAD_64_OPT_comp,glsl_sdpa_flash_coopmat_mnn_D_HEAD_64_OPT_comp_len)));
mMaps.insert(std::make_pair("glsl_sdpa_flash_coopmat_mnn_D_HEAD_128_OPT_comp", std::make_pair(glsl_sdpa_flash_coopmat_mnn_D_HEAD_128_OPT_comp,glsl_sdpa_flash_coopmat_mnn_D_HEAD_128_OPT_comp_len)));
